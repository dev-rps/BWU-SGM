...
class MapProviderState {
  ...
  // Route layers are managed by React <Source>/<Layer> components in NavigationPage
  // to avoid race conditions between setStyle() wipes and imperative data injection
  getMapLibreStyle() {
